...
if($jns=="0"){
	...
	<?php 
		...
		while($s=$query->fetch_assoc()) {
			...
			$nh='
				<span class="input-group-addon" contenteditable="true" data-old_value="'.$nHar.'"  onBlur="saveHarian(this,\'nilai\',\''.$idp.'\',\''.$ab.'\',\''.$smt.'\',\''.$tapel.'\',\''.$mpid.'\',\''.$kd.'\',\''.$jns.'\',\''.$tema.'\')" onClick="highlightEdit(this);">'.$nHar.'</span>
			';
		?>
		<tr>
			<td><?=$s['nama'];?></td>
