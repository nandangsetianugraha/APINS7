...
<body>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group form-group-default">
								<label>Kelas</label>
								<input type="hidden" id="tapel" class="form-control" value="<?=$tapel;?>" placeholder="Username">
								<input type="hidden" id="smt" class="form-control" value="<?=$smt;?>" placeholder="Username">
	...
	$(document).ready(function() {
		manageMemberTable = $("#manageMemberTable").DataTable({
			...
			"searching": false,
			"paging":false,
			"ajax": "modul/siswa/kelasku.php?kelas=0&smt=0&tapel=0",
			"order": []
		});
