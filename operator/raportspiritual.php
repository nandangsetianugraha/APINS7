...
?>
	<div class="wrapper overlay-sidebar">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Generate Sikap Spiritual</h4>
					</div>
					<div class="row">
						<div class="col-md-3">
		...
		<div class="modal fade" id="mod-raport" tabindex="-1" role="dialog" aria-labelledby="copycourse" aria-hidden="true">
	...
	$(document).ready(function() {
		Raportku = $("#Raportku").DataTable({
						...
						"searching": false,
						"paging":false,
						"ajax": "modul/raport/RaportSpiritual.php?kelas=0&tapel=0&smt=0",
						"order": []
					});
		$('#kelas').change(function(){
			...
			var smt=$('#smt').val();
			var tapel=$('#tapel').val();
			$('.page-title').html('Generate Sikap Spiritual Kelas '+kelas);
			Raportku = $("#Raportku").DataTable({
						"destroy":true,
						"searching": false,
						"paging":false,
