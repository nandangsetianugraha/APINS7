...
if($_POST) {	
	...
	if(empty($nama) || empty($tanggal)){
		...
		$validator['messages'] = "Nama dan tanggal lahir tidak boleh kosong!";
			...
			$sql1 = "INSERT INTO siswa VALUES('','$id_pd','$nis','$nisn','$nama','$jk','$tempat','$tanggal','$nik','$agama','$pend','$alamat','$ayah','$ibu','$pek_ayah','$pek_ibu','$jalan','$kelurahan','$kecamatan','$kabupaten','$provinsi','avatar.png','1','0')";
