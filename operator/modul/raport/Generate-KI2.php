...
if($SB12==$PB12){
								...
								if($nspi1>0){
									...
									mysqli_query($koneksi, "insert into nso_temp values('','$idp','$kelas','$smt','$tapel','1','$pred1')");
								};
								if($nspi2>0){
									...
									mysqli_query($koneksi, "insert into nso_temp values('','$idp','$kelas','$smt','$tapel','2','$pred2')");
								};
								if($nspi3>0){
									...
									mysqli_query($koneksi, "insert into nso_temp values('','$idp','$kelas','$smt','$tapel','3','$pred3')");
								};
								if($nspi4>0){
									...
									mysqli_query($koneksi, "insert into nso_temp values('','$idp','$kelas','$smt','$tapel','4','$pred4')");
								};
								if($nspi5>0){
									...
									mysqli_query($koneksi, "insert into nso_temp values('','$idp','$kelas','$smt','$tapel','5','$pred5')");
								};
								if($nspi6>0){
									...
									mysqli_query($koneksi, "insert into nso_temp values('','$idp','$kelas','$smt','$tapel','6','$pred6')");
								};
								$vy1="";$dk1="";$dk="";
								$vy2="";$dk2="";
								$vy3="";$dk3="";
		...
		if($ada>0){
			...
			mysqli_query($koneksi, "INSERT INTO deskripsi_k13 VALUES('','$idp','$ab','$smt','$tapel','k2','$desk')");
