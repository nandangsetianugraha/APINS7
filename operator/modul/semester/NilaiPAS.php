...
if($kd==0){
	...
	<?php 
		...
		while($s=$query->fetch_assoc()) {
			...
			$nkd='
			<span class="input-group-addon" contenteditable="true" data-old_value="'.$nPTS.'"  onBlur="saveUA(this,\'nilai\',\''.$idp.'\',\''.$kelas.'\',\''.$smt.'\',\''.$tapel.'\',\''.$mpid.'\',\''.$kd.'\')" onClick="highlightEdit(this);">'.$nPTS.'</span>
			';
		?>
		<tr>
			<td><?=$s['nama'];?></td>
